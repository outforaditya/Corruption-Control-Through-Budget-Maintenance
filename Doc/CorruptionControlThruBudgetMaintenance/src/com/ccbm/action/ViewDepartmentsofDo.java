...
public class ViewDepartmentsofDo extends HttpServlet {
	...
	try{
		...
		if(!vdo.isEmpty()){
			...
			path=UtilConstants._VIEW_DEPT_FOR_DEPTOFFICERS;
		...
		request.setAttribute("status", UtilConstants._NO_DEPT_OFFICERS);
		path=UtilConstants._VIEW_DEPT_FOR_DEPTOFFICERS;
