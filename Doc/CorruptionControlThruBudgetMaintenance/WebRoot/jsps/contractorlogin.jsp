...
setTimeout("disableBackButton()", 0);
 ...
 <jsp:include page="header.jsp"></jsp:include>
        ...
        <form action="<%=request.getContextPath()+"/ContractorLoginAction"%>" method=post name="login">
                 ...
                 <td><table border="0" align="center" bgcolor="">
                   ...
                   <tr>
                     <td colspan="2">
                      ...
                      <tr></tr>
                      <tr>
               <td></td><td align="left">&nbsp;<a href="./jsps/citizenregistration.jsp"><b style="color: black;">New User Sign Up !...</b></a></td>
               </tr>
               <tr>
               <td></td><td align="left">&nbsp;<a href="./jsps/recoverpassword.jsp"><b style="color: black;">Forgot Password...?</b></a></td>
               </tr>
                 </table></td>
                 <td>&nbsp;</td>
               </tr>
