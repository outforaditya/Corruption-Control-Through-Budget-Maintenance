...
setTimeout("disableBackButton()", 0);
  ...
  <form action="./InsertContractorWorkAction" method="post" name="frm">
   <table align="center" border="1" bgcolor="#A1B2C3" width="70%" cellpadding="10">
   <caption><h3>Work Information</h3></caption>
   ...
   <c:forEach var="officer" items="${trans}">
    ...
    <tr><td>Work  Nmae</td><td><input type="text" name="workname" value="${officer.workname}" readonly="readonly"></td></tr>
    
    <tr><td>Department</td><td><input type="text" name="dept" value="${officer.deptname}" readonly="readonly"></td></tr>
    <tr><td>Number of Workers</td><td><input type="text" name="number" value=""></td></tr>
    <tr><td>Work Start Date</td><td>
   <input type="text" name="dob" value="" size="20" readonly="readonly" /><a href="javascript:show_calendar('document.frm.dob', document.frm.dob.value);"> <img src="<%=request.getContextPath()+"/images/cal.gif"%>" alt="a" width="18" height="18" border="0"/></a> </td></tr>
    <tr><td>End date</td><td><input type="text" name="dob1" value="" size="20" readonly="readonly" /><a href="javascript:show_calendar('document.frm.dob1', document.frm.dob1.value);"> <img src="<%=request.getContextPath()+"/images/cal.gif"%>" alt="a" width="18" height="18" border="0"/></a></td></tr>
    <tr><td>Released Amount</td><td><input type="text" name="amount" value="${officer.amount}" readonly="readonly"></td></tr>
    <tr><td>Amount Spent</td><td><input type="text" name="spent" value=""></td></tr>
    
    <tr>
    <td width="139"><span class=Title>   Work Status</span></td>
    <td width="276">
      <select name="status">
    ...
    <tr>
    <td><span class=Title>    Browse Work  Photo</span></td>
