...
setTimeout("disableBackButton()", 0);
  ...
  <body onload="javascript:disableBackButton()">
    ...
    <table width="637" border="0" align="center" bordercolor="#8692E3">
        ...
        <td width="372"><div align="center" class="style8">Reply</div></td>
      </tr>
        ...
        <c:choose>
        <c:when test="${que.qstatus eq 'NOT SOLVED' or que.qstatus eq 'NOTSOLVED'}">
        
        <a href="./jsps/replytoquery.jsp?qid=${que.qid }&userid=${que.userid }&username=${que.name}"> Replay</a>
        </c:when>
        <c:otherwise>No Queries
      <br />
      </c:otherwise>
        </c:choose>
