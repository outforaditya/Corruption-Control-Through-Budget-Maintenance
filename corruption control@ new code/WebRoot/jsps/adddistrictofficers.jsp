...
window.location.href="<%=request.getContextPath()%>/DistcoChekUserAction?userName="+userName+"&deptname="+dName;
...
font-size:8pt
		...
		<body>
		 <jsp:include page="header.jsp"></jsp:include>
		   <h3><div align="center"><span class=subHead>District Officer Register Form </span></div></h3>
...
<tr>
    ...
    <td><input type="text" name="role" value="distco" readonly="readonly" size="20"/></td>
</tr>
<tr>
