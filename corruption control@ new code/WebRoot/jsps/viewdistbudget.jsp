...
<span class="style13">Report Export to : <a href="./ExportXLS" target="_blank"><font color="brown">XLS</font></a></span><br/>
   ...
   <caption>District Budget</caption>
     ...
     <br/><br/>
     <tr><th bgcolor="lightgreen"><b>Department</b></th><th bgcolor="lightgreen"><b>Subdepartment</b></th><th bgcolor="lightgreen"><b>District</b></th><th bgcolor="lightgreen"><b>DistributedTo</b></th><th bgcolor="lightgreen"><b>BudgetDate</b></th><th bgcolor="lightgreen"><b> Amount</b></th><th bgcolor="lightgreen"><b>Financial year</b></th> 
   </tr>
 ...
 <% String report="";
           ...
           report+=" <tr><td>Deartment</td><td>SubDepartment</td><td>District</td><td>Distributed To</td><td><BudgetDate/td><td>Amount</td><td>Year</td></tr>"; 
	...
	report+= "<tr><td align='center'><b>"+r.getDeptname()+"</b></td><td align='center'><b>"+r.getSubdeptname()+"</td><td align='center'><b>"+r.getDistrict()+"</b></td><td align='center'><b>"+r.getDistributedby()+"</b></td><td align='center'><b>"+r.getBudgetdate()+"</b></td><td align='center'><b>"+r.getAmount()+"</b></td><td align='center'><b>"+r.getYear()+"</b></td></tr>";
		}
		report+="</table>";
