  ...
  <body onload="javascript:disableBackButton()">
   ...
   <font color="red">
		 <c:if test="${'requestScope.status'!='null'}">
			...
			<center><h2><font color="#1236890">Send Query</font></h2></center>
		  <div class="hr"> </div>
          <p></p> 
					<form  method="post" action="<%=request.getContextPath()+"/QueryAction"%>" onsubmit="return validation();">
					  <table width="337" border="2" align="center">
                        ...
                        <tr>
                          ...
                          <td><label>
                            <input type=text name="to"   size="48"  value="Finance Minister" readonly="readonly"/>
                          </label></td>
                        </tr>
                        <tr>
                   ...
                   <input type=text name="date" readonly="readonly" value="<%=reportDate %>"/>
                        ...
                        <tr>
                          <td colspan="2"><label>
                            <div align="center">
                              <input type=submit value=PostQuery>
                             </div>
                          </label></td>
                        </tr>
                      </table>
