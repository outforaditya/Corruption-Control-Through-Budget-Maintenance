...
<ul id='nav'>
<li> <a href=<%=request.getContextPath()+"/jsps/citizenhome.jsp" %>  >Home</a>
<ul>
</ul>


<li> <a href='#'>BudgetDetails</a>
<ul>
<li style='background-color:lightblue;'> <a href="<%=request.getContextPath()+"/ViewDeptforCitzenAction"%>">ViewStateBudget</a></li>
<li style='background-color:lightblue;'><a href="<%=request.getContextPath()+"/ViewDistforCitzenAction"%>">ViewDistrictBudget</a></li>
...
<li> <a href=<%=request.getContextPath()+"/jsps/citizenfeedback.jsp" %>  >Feedback</a>
<ul>
</ul>
