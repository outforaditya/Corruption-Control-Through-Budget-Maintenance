...
public class ViewDistDistribuetdAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			try{
				...
				//vb=new RegisterMgrDelegate().viewDistBudget(distname);
				vb=new RegisterMgrDelegate(). viewDistDistributedBudget(loginid);
			...
			if(!vb.isEmpty()){
				...
				request.setAttribute("distbudget", vb);
					...
					path=UtilConstants._VIEW_DIST_DISTRIBUTEDBUDGET;
			}
			else if(vb.isEmpty())
			{
