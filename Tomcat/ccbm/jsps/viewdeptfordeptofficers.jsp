...
setTimeout("disableBackButton()", 0);
  ...
  <center><b><h2>Departments</h2></b></center>
		...
		<table cellspacing=2 align="center" bgcolor="#CEF6CE" width="325" height="60">
				...
				<select name="dname" id="select" onchange="javascript:if(document.budget.dname.value==''){alert('Select Any Department');}  {location.href='./ViewDeptOffAction?dept='+document.budget.dname.value;}">
				<c:choose>
				...
				<option value="${depart.addresstype}">								
				${depart.addresstype}
				</option>
				</c:forEach>
				</c:if>
