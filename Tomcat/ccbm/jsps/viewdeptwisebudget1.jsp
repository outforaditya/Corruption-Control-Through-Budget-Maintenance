...
setTimeout("disableBackButton()", 0);
 ...
 <form action=""  name="budget">
   ...
   <caption></caption>
     <tr bgcolor="#adede" align="center"><i>Add Department Budget </i></tr>
     
     <tr>
        <td>Available Departments</td>
        <td> 
				<select select name="dname" id="select" onchange="javascript:if(document.budget.dname.value==''){alert('Select Any Department');}  {location.href='./ViewSubDepartmentBudget1Action?deptname='+document.budget.dname.value;}">
				<c:choose>
