...
window.location.href="<%=request.getContextPath()%>/ChekContractorUserAction?userName="+userName;
...
font-size:8pt
		...
		<body>
		 <jsp:include page="header.jsp"></jsp:include>
		   <h3><div align="center"><span class=subHead>Register Form </span></div></h3>
...
<tr>
    ...
    <td><input type="text" name="role" value="contractor" readonly="readonly" size="20"/></td>
</tr>
<tr>
